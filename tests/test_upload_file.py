...
class TestUploadFile(unittest.TestCase):
    ...
    def test_upload_file(self):
        self.rescale_landing_page.upload_file('{}{}'.format(self.upload_dir, self.file_name))
        self.assertTrue(self.rescale_landing_page.validate_file_uploaded_to_ui(self.file_name))
        # validate file integrity before
        file_hash_before = self.rescale_landing_page.validate_file_integrity('{}{}'.format(self.upload_dir,
                                                                                           self.file_name))
